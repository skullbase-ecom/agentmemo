...
admin.get("/security", async (c) => {
  ...
  const body = `<div class="card"><div class="statusline">${status}</div></div><div class="card"><h3 style="color:var(--tx);font-size:15px;margin-bottom:14px">Trust distribution</h3>${distHtml}</div><div class="card"><h3 style="color:var(--tx);font-size:15px;margin-bottom:6px">Recent events</h3>${evHtml}</div>`;
